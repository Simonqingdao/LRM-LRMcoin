...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. LRM can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("LRM");
    app.setOrganizationDomain("LRM.su");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("LRM-Qt-testnet");
    else
        app.setApplicationName("LRM-Qt");
